...
// (بخش ۲ مستند پروژه): زوم با چرخ‌ماوس (چرخاندن به جلو/عقب، بدون نیاز به کلید
// Ctrl - بخش ۲ درخواست کاربر)، Pan با نگه‌داشتن Space، و اعلام موقعیت لحظه‌ای
// ماوس روی بوم برای نمایش در نوار وضعیت.
