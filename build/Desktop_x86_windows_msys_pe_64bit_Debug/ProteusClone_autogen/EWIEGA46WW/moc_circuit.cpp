...
static constexpr auto qt_meta_stringdata_ZN7CircuitE = QtMocHelpers::stringData(
    "Circuit"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN7CircuitE[] = {
...
Q_CONSTINIT const QMetaObject Circuit::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7CircuitE.offsetsAndSizes,
    qt_meta_data_ZN7CircuitE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7CircuitE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<Circuit, std::true_type>
    >,
    nullptr
} };
...
void *Circuit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7CircuitE.stringdata0))
