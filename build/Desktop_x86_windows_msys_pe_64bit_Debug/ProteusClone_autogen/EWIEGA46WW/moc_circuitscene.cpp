...
static constexpr auto qt_meta_stringdata_ZN12CircuitSceneE = QtMocHelpers::stringData(
    "CircuitScene"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12CircuitSceneE[] = {
...
Q_CONSTINIT const QMetaObject CircuitScene::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12CircuitSceneE.offsetsAndSizes,
    qt_meta_data_ZN12CircuitSceneE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12CircuitSceneE_t,
        // Q_OBJECT / Q_GADGET
...
void *CircuitScene::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12CircuitSceneE.stringdata0))
